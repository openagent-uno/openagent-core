...
The `1.1.0b4` kernel and SQLite adapter are the current modular release
...
[`v1.1.0-beta.4`](https://github.com/openagent-uno/openagent-core/releases/tag/v1.1.0-beta.4).

```sh
pip install --find-links /path/to/verified-wheelhouse \
  openagent-core==1.1.0b4 openagent-storage-sqlite==1.1.0b4
# Hosts that need the full algorithm select the relevant extras:
pip install --find-links /path/to/verified-wheelhouse \
  'openagent-core[engine,providers,modules,retrieval]==1.1.0b4'
```
