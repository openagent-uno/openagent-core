...
The `1.1.0b2` kernel and SQLite adapter are the current modular release
...
[`v1.1.0-beta.2`](https://github.com/openagent-uno/openagent-core/releases/tag/v1.1.0-beta.2).

```sh
pip install --find-links /path/to/verified-wheelhouse \
  openagent-core==1.1.0b2 openagent-storage-sqlite==1.1.0b2
# Hosts that need the full algorithm select the relevant extras:
pip install --find-links /path/to/verified-wheelhouse \
  'openagent-core[engine,providers,modules,retrieval]==1.1.0b2'
```
