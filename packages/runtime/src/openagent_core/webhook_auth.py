...
Two layers, in order:
1. **Secret** — every event carries a per-event secret (encrypted at rest).
...
from openagent_core.core.event_types import EVENT_TYPES, REPLAY_WINDOW_S
...
def authenticate(
    *,
    ...
    useless.
    """
    from .core.event_secret import decrypt_secret, verify_secret
