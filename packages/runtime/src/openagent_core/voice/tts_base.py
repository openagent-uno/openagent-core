...
from openagent_core.voice import tts as _tts
from openagent_core.voice import tts_local as _piper
from openagent_core.voice import tts_streaming as _wsstream
from openagent_core.voice.tts_chunker import SentenceChunker
    ...
    async def synthesize_full(
        ...
        *,
        ...
        if (
            ...
            and not runtime_environment().get("OPENAGENT_PIPER_VOICE")
        ):
            voice_arg = None
