...
async def t_openai_parser_shape(ctx: TestContext) -> None:
    from openagent_core.models.discovery import _parse_openai_style
...
async def t_google_parser(ctx: TestContext) -> None:
    from openagent_core.models.discovery import _parse_google
...
async def t_openrouter_filter(ctx: TestContext) -> None:
    from openagent_core.models.discovery import _openrouter_filter_for
