...
async def t_hub_register_get(ctx: TestContext) -> None:
    from openagent_core.mcp.servers.shell.hub import ShellHub
...
async def t_shell_exec_diag_events(ctx: TestContext) -> None:
    ...
    _reset_shell_hub()
    from openagent_core.core.logging import EVENT_LOGGER
    from openagent_core.mcp.servers.shell import handlers
...
async def t_shell_finalise_bounded_with_grandchild_holding_pipes(ctx: TestContext) -> None:
    ...
    from openagent_core.mcp.servers.shell.shells import (
        BackgroundShell,
        FINALISE_TIMEOUT,
    )
...
async def t_adapter_agno(ctx: TestContext) -> None:
    from openagent_core.mcp.servers.shell.adapters import build_runtime_toolkit
...
async def t_handlers_session_ctxvar(ctx: TestContext) -> None:
    from openagent_core.mcp.servers.shell import handlers, adapters
