...
async def t_is_blocked_attachment(ctx: TestContext) -> None:
    from openagent_core.channels.base import is_blocked_attachment
...
async def t_build_attachment_context(ctx: TestContext) -> None:
    from openagent_core.channels.base import (
...
async def t_split_code_blocks(ctx: TestContext) -> None:
    from openagent_core.channels.base import split_preserving_code_blocks
